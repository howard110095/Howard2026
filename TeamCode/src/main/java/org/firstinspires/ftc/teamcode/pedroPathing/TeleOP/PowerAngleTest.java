...
@Configurable
@TeleOp(name = "PowerAngleTest", group = "Linear OpMode")
public class PowerAngleTest extends RobotBase {
    public static double targetVelocity = 3000, angle = 40;
    ...
    public void robotLoop() {
        intake.on();
        colorSpinner.on();
        shooter.shootingPRO(0, targetVelocity, -500, angle, true);
