...
public class Auto extends RobotBase {
    ...
    public void buildPaths() {
        path0 = follower.pathBuilder()
                .addPath(new BezierLine(startingPose, shootingBluePose))
                .setLinearHeadingInterpolation(startingPose.getHeading(), shootingBluePose.getHeading())
                .build();
...
//        park.setLinearHeadingInterpolation(scorePose.getHeading(), parkPose.getHeading());
    ...
    public void autonomousPathUpdate() {
        if (pathState == 0) {
            ...
            if (pathTimer.getElapsedTimeSeconds() >= 0.4) setPathState(11);
        }
        //to 1 roll
...
//        }
    ...
    public void robotLoop() {
        //vision
        if (pathState == 11) shooter.visionTracking(1);
