...
public class RobotConstants {
    ...
    //Auto
    public static double shootingTime = 2.2, toReadyShootingTime = 0.5,quickShootTime = 0.7;
    ...
    //short shoot
//    public static Pose blueShortControl2 = new Pose(-20, -12, Math.toRadians(180));
    public static Pose blueToGateControl2 = new Pose(-20, -6, Math.toRadians(180));
    public static Pose blueOpenGate = new Pose(-53.5, -6, Math.toRadians(180));
    public static Pose blueCatchFromGate = new Pose(-59, -9, Math.toRadians(135));
    public static Pose blueBackFromGateControl = new Pose(-20, -12, Math.toRadians(180));


    //long shoot
    public static Pose blueLongShootingPose = new Pose(-15, -61, Math.toRadians(180));
